 ...
 * under the License.
 */
package org.wso2.carbon.identity.integration.c4;
...
public class Bootstrap {
    ...
    protected final void loadClass(String args[]) {
        ...
        try {
            ...
            ClassLoader balCl = createExtendedRuntimeClassloader("/Users/ruwan/Dev/ballerina-lang/ballerina/distribution/zip/ballerina/target/ballerina-0.970.0-alpha1-SNAPSHOT/bre/lib");
//            ClassLoader unifiedCl = new UnifyingClassloader()
    ...
    private void addSystemProperties() {
        ...
        String filePath =
                ROOT + File.separator + "repository" + File.separator + "conf" + File.separator + CARBON_PROPERTIES;
    ...
    private ClassLoader createExtendedRuntimeClassloader(String dir) {
