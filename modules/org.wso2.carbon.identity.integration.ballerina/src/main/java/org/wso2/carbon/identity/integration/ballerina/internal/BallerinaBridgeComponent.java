 ...
 */
@Component(name = "wso2identity.integration.ballerina.component", immediate = true)
public class BallerinaBridgeComponent {
    ...
    protected void activate(ComponentContext componentContext) {
        ...
        System.out.println("Started ballerina ");
    }
    ...
    private void activateB7a(String carbonHome) {
        ...
        System.out.println("=========== ======== Activating ballerina on path : " + ballerinaFilePath);
        try {
            host.start();
        } catch (Throwable be) {
            be.printStackTrace();
    ...
    protected void deactivate(ComponentContext componentContext) {
        ...
        System.out.println("Stopping ballerina ");
        if (host != null) {
            host.stop();
        }
        System.out.println("Stopped ballerina ");
    }
